INSERT INTO articles VALUES
    ...
    (3, 'Example42', 'Federico Bottoni', 'I want to buy a onesie… but know it won’t suit me.
    ...
    (4, 'Example82', 'Nassim Habbash', 'A purple pig and a green donkey flew a kite in the middle of the night and ended up sunburnt.
        He ran out of money, so he had to stop playing poker.
        Last Friday in three week’s time I saw a spotted striped blue worm shake hands with a legless lizard.
        Italy is my favorite country; in fact, I plan to spend two weeks there next year.
        She borrowed the book from him many years ago and has not yet returned it.
